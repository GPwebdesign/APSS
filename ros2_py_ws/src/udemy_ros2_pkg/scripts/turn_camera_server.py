...
class TurnCameraServer(Node):
    ...
    def return_image(self, request, response):
        print(f"Request Received ..processing angle {request.degree_turn}")
        #ricorda il servizio ha una richiesta con nome degree_turn di tipo float32
        #e una risposta con nome image di tipo sensor_msgs/Image
        #
        # float32 degree_turn
        # ---
    ...
    def get_image(self, angle):
        ...
        print(f"The closest angle is:{closest_angle}°")
